...
export default function ShoppingCart({ handleCart }: any) {
  ...
  // feedback:
  // why savedCartString is a let? (check let vs const)
  // try to use || and ??
  ...
  // feedback: not sure why this is being called with an index? can't we just pass the item id in the first place.
