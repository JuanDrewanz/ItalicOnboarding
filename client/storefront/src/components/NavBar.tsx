...
export default function NavBar() {
  ...
  // feedback: good to see you are using a hook
  // please make sure you understand how it works in case it's referenced from other projects
  const { user } = useAuth();

  // feedback: better naming is toggle cart and set show cart (?)
  const handleCart = () => {
