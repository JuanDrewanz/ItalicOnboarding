...
// feedback: should put this in its own file to avoid clutter
function RegisterUser() {
  ...
  const [registerUser, { loading, error }] = useMutation(REGISTER_USER, {
    ...
    onCompleted: async function (data) {
      // feedback: note that not all devices and browsers support local storage
      // you should either use a custom hook with try catch or a library like https://www.npmjs.com/package/local-storage
