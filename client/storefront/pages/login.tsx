...
function LoginUser() {
  ...
  // feedback: "any" type should only be used as a last resort
              ...
              <div className="lg:flex lg:flex-wrap g-0">
                <div className="lg:w-6/12 px-4 md:px-0">
                  <div className="md:p-12 md:mx-6">
                    {/* feedback: kind of feels like too much nesting? at this point it's confusing what div contains what */}
