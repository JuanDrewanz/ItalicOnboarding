              ...
              <div className="container mx-auto flex flex-col md:flex-row items-center my-12 md:my-24">
                <div className="flex flex-col w-full lg:w-1/3 justify-center items-center p-8">
                  ...
                  <div className="flex flex-col w-full text-center">
                    {/* feedback: use Link throughout with anchor wrapped in it
                     unless there is a specific use case for anchor for ex. external pages */}
                    {/* feedback: URLs are generally separated by - i.e. categories-home */}
                    <a
                      href="/categoriesHome"
